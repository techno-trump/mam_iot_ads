...
var $;
(function ($) {
    class $ayk_iot_ads_frame extends $mol_frame {
    }
    $.$ayk_iot_ads_frame = $ayk_iot_ads_frame;
})($ || ($ = {}));
//ayk/iot/ads/frame/-view.tree/frame.view.tree.ts
;
"use strict";
var $;
(function ($) {
    class $ayk_iot_ads_composition extends $mol_view {
        Frame(id) {
            const obj = new this.$.$ayk_iot_ads_frame();
            return obj;
        }
    }
    __decorate([
        $mol_mem_key
    ], $ayk_iot_ads_composition.prototype, "Frame", null);
    $.$ayk_iot_ads_composition = $ayk_iot_ads_composition;
})($ || ($ = {}));
//ayk/iot/ads/composition/-view.tree/composition.view.tree.ts
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    var $$;
    (function ($$) {
        class $ayk_iot_ads_composition extends $.$ayk_iot_ads_composition {
            current_frame_data(next) {
                return next;
            }
        ...
        __decorate([
            $mol_mem
        ], $ayk_iot_ads_composition.prototype, "current_frame_data", null);
        __decorate([
            $mol_wire_plex
        ], $ayk_iot_ads_composition.prototype, "current_frame", null);
        $$.$ayk_iot_ads_composition = $ayk_iot_ads_composition;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//ayk/iot/ads/composition/composition.view.ts
;
"use strict";
var $;
(function ($) {
    var $$;
    (function ($$) {
        $mol_style_define($ayk_iot_ads_composition, {
            position: "relative",
            left: 0,
            top: 0,
            width: "100%",
            paddingTop: "var(--height-ratio, 50%)",
            Frame: {
                position: "absolute",
                left: 0,
                top: 0,
...
//ayk/iot/ads/composition/composition.view.css.ts
;
"use strict";
var $;
(function ($) {
...
var $;
(function ($) {
    class $ayk_iot_ads_player extends $mol_view {
        meta() {
    ...
    __decorate([
        $mol_mem
    ], $ayk_iot_ads_player.prototype, "meta", null);
    __decorate([
        $mol_mem
    ], $ayk_iot_ads_player.prototype, "Player_title", null);
    $.$ayk_iot_ads_player = $ayk_iot_ads_player;
})($ || ($ = {}));
//ayk/iot/ads/player/-view.tree/player.view.tree.ts
;
"use strict";
var $;
(function ($) {
    var $$;
    (function ($$) {
        class $ayk_iot_ads_player extends $.$ayk_iot_ads_player {
        }
        $$.$ayk_iot_ads_player = $ayk_iot_ads_player;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//ayk/iot/ads/player/player.view.ts
;
"use strict";
var $;
(function ($) {
...
var $;
(function ($) {
    class $ayk_iot_ads_page extends $mol_view {
        sub() {
            return [
                this.Composition(),
                this.Player()
    ...
    __decorate([
        $mol_mem
    ], $ayk_iot_ads_page.prototype, "Composition", null);
    __decorate([
        $mol_mem
    ], $ayk_iot_ads_page.prototype, "Player", null);
    $.$ayk_iot_ads_page = $ayk_iot_ads_page;
})($ || ($ = {}));
//ayk/iot/ads/page/-view.tree/page.view.tree.ts
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    var $$;
    (function ($$) {
        class $ayk_iot_ads_page extends $.$ayk_iot_ads_page {
            static app_config() {
                return $mol_fetch.json("./ayk/iot/ads/config.json");
            }
            static player_meta() {
                return $mol_fetch.json(`${$ayk_iot_ads_page.app_config().configUri}?id=${$ayk_iot_ads_page.meta_id()}`);
            }
            static meta_id() {
        ...
        __decorate([
            $mol_mem
        ], $ayk_iot_ads_page.prototype, "player_meta", null);
        __decorate([
            $mol_mem
        ], $ayk_iot_ads_page, "app_config", null);
        __decorate([
            $mol_mem
        ], $ayk_iot_ads_page, "player_meta", null);
        $$.$ayk_iot_ads_page = $ayk_iot_ads_page;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//ayk/iot/ads/page/page.view.ts
